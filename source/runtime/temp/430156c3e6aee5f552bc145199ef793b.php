<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/app.52juanmi.com/web/../source/application/store/view/passport/login.php";i:1552528057;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="container">
    <div id="wrapper" class="login-body">
        <div class="login-content">
            <div class="brand">
                <img alt="logo" class="brand-img" src="assets/store/img/jm_logo.png">
                <h2 class="brand-text">卷米电商系统</h2>
            </div>
