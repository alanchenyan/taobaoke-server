<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"/www/wwwroot/app.52juanmi.com/web/../source/application/store/view/article/edit.php";i:1556610662;s:78:"/www/wwwroot/app.52juanmi.com/source/application/store/view/layouts/layout.php";i:1554087003;s:95:"/www/wwwroot/app.52juanmi.com/source/application/store/view/layouts/_template/tpl_file_item.php";i:1554215245;s:94:"/www/wwwroot/app.52juanmi.com/source/application/store/view/layouts/_template/file_library.php";i:1554215402;s:89:"/www/wwwroot/app.52juanmi.com/source/application/store/view/goods/_template/spec_many.php";i:1544593526;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <option value="1" <?= $model['atype'] == 1? 'selected' : '' ?> >新手入门(学院)</option>
                                         <option value="2" <?= $model['atype'] == 2? 'selected' : '' ?> >高级学院(学院)</option>
                                         <option value="3" <?= $model['atype'] == 3? 'selected' : '' ?>>经验分享(学院)</option>
                                         <option value="4" <?= $model['atype'] == 4? 'selected' : '' ?>>常见问题</option>
                                         <option value="5" <?= $model['atype'] == 5? 'selected' : '' ?>>关于我们</option>
                                         <option value="6" <?= $model['atype'] == 6? 'selected' : '' ?>>其他文章</option>
                                         <option value="7" <?= $model['atype'] == 7? 'selected' : '' ?>>活动文章</option>
                                        <option value="8" <?= $model['atype'] == 8? 'selected' : '' ?>>官方活动</option>
                                        <option value="9" <?= $model['atype'] == 9? 'selected' : '' ?>>教程中心</option>
                                         <option value="0" <?= $model['atype'] == 0? 'selected' : '' ?>>其他</option>
                                    </select>
                             ...
                             <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" value="<?= $model['author'] ?>"  class="tpl-form-input" name="author">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea  id="container"    name="container" type="text/plain"><?= $model['container'] ?></textarea>
                                </div>
