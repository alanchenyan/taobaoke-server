...
class Controller extends ThinkController
{
   ...
   /* private function getWxappId()
     ...
     * @return array
     */
    protected function renderSuccessStr($data = "", $msg = 'success')
    {
        return compact(1, 'msg', 'data');
    }
    ...
    //提醒用户登录
    protected function renderErrorLogin($msg = 'error', $data = [])
    {
        return $this->renderJson(self::JSON_ERROR_LOGIN, $msg, $data);
    }
